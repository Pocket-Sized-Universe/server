...
namespace PocketSizedUniverseShared.Migrations
{
    ...
    [Migration("20250908031001_AddSuperSeederRole")]
    partial class AddSuperSeederRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CharaDataFileRedirectEntry", b =>
                {
                    b.Property<long>("FileRedirectsId")
                        .HasColumnType("bigint")
                        .HasColumnName("file_redirects_id");

                    b.Property<string>("CharaDataId")
                        .HasColumnType("text")
                        .HasColumnName("chara_data_id");

                    b.Property<string>("CharaDataUploaderUID")
                        .HasColumnType("character varying(10)")
                        .HasColumnName("chara_data_uploader_uid");

                    b.HasKey("FileRedirectsId", "CharaDataId", "CharaDataUploaderUID")
                        .HasName("pk_chara_data_file_redirect_entry");

                    b.HasIndex("CharaDataId", "CharaDataUploaderUID")
                        .HasDatabaseName("ix_chara_data_file_redirect_entry_chara_data_id_chara_data_upl");

                    b.ToTable("chara_data_file_redirect_entry", (string)null);
                });

            modelBuilder.Entity("CharaDataTorrentFileEntry", b =>
                {
                    b.Property<long>("FileSwapsId")
                        .HasColumnType("bigint")
                        .HasColumnName("file_swaps_id");
                    ...
                    b.HasKey("FileSwapsId", "CharaDataId", "CharaDataUploaderUID")
                        .HasName("pk_chara_data_torrent_file_entry");

                    b.HasIndex("CharaDataId", "CharaDataUploaderUID")
                        .HasDatabaseName("ix_chara_data_torrent_file_entry_chara_data_id_chara_data_uplo");

                    b.ToTable("chara_data_torrent_file_entry", (string)null);
                });

            modelBuilder.Entity("PocketSizedUniverseShared.Models.Auth", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.Banned", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.BannedRegistrations", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.CharaData", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.CharaDataAllowance", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.CharaDataFile", b =>
                {
                    b.Property<string>("ParentId")
                        .HasColumnType("text")
                        .HasColumnName("parent_id");
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.CharaDataFileSwap", b =>
                {
                    b.Property<string>("ParentId")
                        .HasColumnType("text")
                        .HasColumnName("parent_id");
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.CharaDataOriginalFile", b =>
                {
                    b.Property<string>("ParentId")
                        .HasColumnType("text")
                        .HasColumnName("parent_id");
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.CharaDataPose", b =>
                {
                    b.Property<string>("ParentId")
                        .HasColumnType("text")
                        .HasColumnName("parent_id");
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.ClientPair", b =>
                {
                    b.Property<string>("UserUID")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.FileCache", b =>
                {
                    b.Property<string>("Hash")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.FileRedirectEntry", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("SwapPath")
                        .HasColumnType("text")
                        .HasColumnName("swap_path");

                    b.HasKey("Id")
                        .HasName("pk_file_redirect_entries");

                    b.ToTable("file_redirect_entries", (string)null);
                });

            modelBuilder.Entity("PocketSizedUniverseShared.Models.ForbiddenUploadEntry", b =>
                {
                    b.Property<string>("Hash")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.Group", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.GroupBan", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.GroupPair", b =>
                {
                    b.Property<string>("GroupGID")
                        .HasColumnType("character varying(20)")
                        .HasColumnName("group_gid");
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.GroupPairPreferredPermission", b =>
                {
                    b.Property<string>("UserUID")
                        .HasColumnType("character varying(10)")
                        .HasColumnName("user_uid");
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.GroupTempInvite", b =>
                {
                    b.Property<string>("GroupGID")
                        .HasColumnType("character varying(20)")
                        .HasColumnName("group_gid");
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.LodeStoneAuth", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.TorrentFileEntry", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<byte[]>("TorrentData")
                        .HasColumnType("bytea")
                        .HasColumnName("torrent_data");

                    b.HasKey("Id")
                        .HasName("pk_torrent_file_entries");

                    b.HasIndex("Hash")
                        .HasDatabaseName("ix_torrent_file_entries_hash");

                    b.ToTable("torrent_file_entries", (string)null);
                });

            modelBuilder.Entity("PocketSizedUniverseShared.Models.User", b =>
                {
                    ...
                    b.Property<bool>("IsSuperSeeder")
                        .HasColumnType("boolean")
                        .HasColumnName("is_super_seeder");
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.UserDefaultPreferredPermission", b =>
                {
                    b.Property<string>("UserUID")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.UserPermissionSet", b =>
                {
                    b.Property<string>("UserUID")
                        .HasColumnType("character varying(10)")
                        .HasColumnName("user_uid");
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.UserProfileData", b =>
                {
                    b.Property<string>("UserUID")
                        .HasColumnType("character varying(10)")
                        .HasColumnName("user_uid");
            ...
            modelBuilder.Entity("CharaDataFileRedirectEntry", b =>
                {
                    b.HasOne("PocketSizedUniverseShared.Models.FileRedirectEntry", null)
                        .WithMany()
                        .HasForeignKey("FileRedirectsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_chara_data_file_redirect_entry_file_redirect_entries_file_r");

                    b.HasOne("PocketSizedUniverseShared.Models.CharaData", null)
                        .WithMany()
                        .HasForeignKey("CharaDataId", "CharaDataUploaderUID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_chara_data_file_redirect_entry_chara_data_chara_data_id_cha");
                });

            modelBuilder.Entity("CharaDataTorrentFileEntry", b =>
                {
                    b.HasOne("PocketSizedUniverseShared.Models.TorrentFileEntry", null)
                        .WithMany()
                        .HasForeignKey("FileSwapsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_chara_data_torrent_file_entry_torrent_file_entries_file_swa");
                    ...
                    b.HasOne("PocketSizedUniverseShared.Models.CharaData", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_chara_data_torrent_file_entry_chara_data_chara_data_id_char");
                });

            modelBuilder.Entity("PocketSizedUniverseShared.Models.Auth", b =>
                {
                    b.HasOne("PocketSizedUniverseShared.Models.User", "PrimaryUser")
                        .WithMany()
                        .HasForeignKey("PrimaryUserUID")
                        .HasConstraintName("fk_auth_users_primary_user_uid");

                    b.HasOne("PocketSizedUniverseShared.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.CharaData", b =>
                {
                    b.HasOne("PocketSizedUniverseShared.Models.User", "Uploader")
                        .WithMany()
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.CharaDataFile", b =>
                {
                    b.HasOne("PocketSizedUniverseShared.Models.FileCache", "FileCache")
                        .WithMany()
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.ClientPair", b =>
                {
                    b.HasOne("PocketSizedUniverseShared.Models.User", "OtherUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.Group", b =>
                {
                    b.HasOne("PocketSizedUniverseShared.Models.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.GroupBan", b =>
                {
                    b.HasOne("PocketSizedUniverseShared.Models.User", "BannedBy")
                        .WithMany()
                        .HasForeignKey("BannedByUID")
                        .HasConstraintName("fk_group_bans_users_banned_by_uid");

                    b.HasOne("PocketSizedUniverseShared.Models.User", "BannedUser")
                        .WithMany()
                    ...
                    b.HasOne("PocketSizedUniverseShared.Models.Group", "Group")
                        .WithMany()
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.GroupPair", b =>
                {
                    ...
                    b.HasOne("PocketSizedUniverseShared.Models.User", "GroupUser")
                        .WithMany()
