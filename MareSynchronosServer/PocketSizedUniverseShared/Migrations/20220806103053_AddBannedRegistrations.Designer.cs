...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PocketSizedUniverseServer.Models.Auth", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseServer.Models.Banned", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseServer.Models.BannedRegistrations", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseServer.Models.ClientPair", b =>
                {
                    b.Property<string>("UserUID")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
            ...
            modelBuilder.Entity("PocketSizedUniverseServer.Models.FileCache", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseServer.Models.ForbiddenUploadEntry", b =>
                {
                    b.Property<string>("Hash")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
            ...
            modelBuilder.Entity("PocketSizedUniverseServer.Models.LodeStoneAuth", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseServer.Models.User", b =>
                {
            ...
            modelBuilder.Entity("PocketSizedUniverseServer.Models.Auth", b =>
                {
                    b.HasOne("PocketSizedUniverseServer.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("PocketSizedUniverseServer.Models.ClientPair", b =>
                {
                    b.HasOne("PocketSizedUniverseServer.Models.User", "OtherUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PocketSizedUniverseServer.Models.FileCache", b =>
                {
                    b.HasOne("PocketSizedUniverseServer.Models.User", "Uploader")
                        .WithMany()
