...
namespace PocketSizedUniverseServer.Migrations
{
    ...
    [Migration("20250907115002_MigrateFromStringToByteArrayHashTake2")]
    partial class MigrateFromStringToByteArrayHashTake2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.FileRedirectEntry", b =>
                {
                    ...
                    b.HasIndex("ParentId")
                        .HasDatabaseName("ix_file_redirect_entries_parent_id");
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.TorrentFileEntry", b =>
                {
                    ...
                    b.HasIndex("ParentId")
                        .HasDatabaseName("ix_torrent_file_entries_parent_id");
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.FileRedirectEntry", b =>
                {
                    b.HasOne("PocketSizedUniverseShared.Models.CharaData", "Parent")
                        .WithMany("FileRedirects")
                        .HasForeignKey("ParentId", "ParentUploaderUID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_file_redirect_entries_chara_data_parent_id_parent_uploader_");
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.TorrentFileEntry", b =>
                {
                    b.HasOne("PocketSizedUniverseShared.Models.CharaData", "Parent")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_torrent_file_entries_chara_data_parent_id_parent_uploader_u");
