...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.UserPermissionQuery", b =>
                {
                    b.Property<string>("Alias")
                        .HasColumnType("text")
                        .HasColumnName("alias");
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.UserProfileDataReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PocketSizedUniverseShared.Models.UserProfileDataReport", b =>
                {
                    b.HasOne("PocketSizedUniverseShared.Models.User", "ReportedUser")
                        .WithMany()
                        .HasForeignKey("ReportedUserUID")
                        .HasConstraintName("fk_user_profile_data_reports_users_reported_user_uid");

                    b.HasOne("PocketSizedUniverseShared.Models.User", "ReportingUser")
                        .WithMany()
