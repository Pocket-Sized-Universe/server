...
public class MareDbContext : DbContext
{
    ...
    public DbSet<PocketSizedUniverseShared.Models.TorrentFileEntry> TorrentFileEntries { get; set; }
    public DbSet<PocketSizedUniverseShared.Models.FileRedirectEntry> FileRedirectEntries { get; set; }
