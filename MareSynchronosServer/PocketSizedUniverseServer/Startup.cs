...
using PocketSizedUniverseServer.Controllers;
using PocketSizedUniverseServer.Hubs;
using PocketSizedUniverseServer.Services;

namespace PocketSizedUniverseServer;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddControllers().ConfigureApplicationPartManager(a =>
        {
            ...
            {
                a.FeatureProviders.Add(new AllowedControllersFeatureProvider(typeof(MareServerConfigurationController), typeof(MareBaseConfigurationController), typeof(ClientMessageController), typeof(FileServicesController)));
            }
            else
            {
