...
using PocketSizedUniverseStaticFilesServer.Controllers;
using PocketSizedUniverseStaticFilesServer.Services;
using PocketSizedUniverseStaticFilesServer.Utils;
using MessagePack;
...
namespace PocketSizedUniverseStaticFilesServer;
...
public class Startup
{
    ...
    public Startup(IConfiguration configuration, ILogger<Startup> logger)
    {
        ...
        _logger = logger;
        var mareSettings = Configuration.GetRequiredSection("PocketSizedUniverse");
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.Configure<StaticFilesServerConfiguration>(Configuration.GetRequiredSection("PocketSizedUniverse"));
        services.Configure<MareConfigurationBase>(Configuration.GetRequiredSection("PocketSizedUniverse"));
        services.Configure<KestrelServerOptions>(Configuration.GetSection("Kestrel"));
        services.AddSingleton(Configuration);

        var mareConfig = Configuration.GetRequiredSection("PocketSizedUniverse");
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseEndpoints(e =>
        {
            if (_isMain)
            {
                e.MapHub<PocketSizedUniverseServer.Hubs.MareHub>("/dummyhub");
            }
