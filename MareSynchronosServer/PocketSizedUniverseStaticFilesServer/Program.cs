...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        using (var scope = host.Services.CreateScope())
        {
            ...
            logger.LogInformation("Loaded PocketSizedUniverse Static Files Server Configuration (IsMain: {isMain})", options.IsMain);
            logger.LogInformation(options.ToString());
            logger.LogInformation("Loaded PocketSizedUniverse Server Auth Configuration (IsMain: {isMain})", optionsServer.IsMain);
