using PocketSizedUniverseAuthService.Controllers;
...
using System.Net;
using PocketSizedUniverseAuthService.Services;
using PocketSizedUniverseShared.RequirementHandlers;
...
namespace PocketSizedUniverseAuthService;
...
public class Startup
{
    ...
    {
        var mareConfig = _configuration.GetRequiredSection("PocketSizedUniverse");
        ...
        services.Configure<AuthServiceConfiguration>(_configuration.GetRequiredSection("PocketSizedUniverse"));
        services.Configure<MareConfigurationBase>(_configuration.GetRequiredSection("PocketSizedUniverse"));
