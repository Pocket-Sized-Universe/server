using PocketSizedUniverseServices;
...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        using (var scope = host.Services.CreateScope())
        {
            ...
            logger.LogInformation("Loaded PocketSizedUniverse Services Configuration (IsMain: {isMain})", options.IsMain);
            logger.LogInformation(options.ToString());
            logger.LogInformation("Loaded PocketSizedUniverse Server Configuration (IsMain: {isMain})", optionsServer.IsMain);
